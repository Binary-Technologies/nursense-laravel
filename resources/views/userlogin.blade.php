          ...
          <div class="docu-details item-flex-center">
            ...
            <form method="POST" action="/userLogin" autocomplete="off" class="col-md-12 mx-2 my-2">
              ...
              <div class="form-group input-group-sm">
                ...
                <input type="email" name='email' id='email' class="form-control login_text ttl-23 comp-width-402 comp-height-60"
                placeholder="아이디를 입력하세요." aria-describedby="Email" required style="{{session('errors') ? 'border: #FF625F thin solid' : ''}}">
              </div>
  
              <div class="form-group input-group-sm">
                <label for="password" class="login_desc"><small>비밀번호</small></label>
                <input type="password" name='password' id='password' class="form-control login_text ttl-23 comp-width-402 comp-height-60"
                placeholder="비밀번호를 입력하세요." required style="{{session('errors') ? 'border: #FF625F thin solid' : ''}}">
              </div>
