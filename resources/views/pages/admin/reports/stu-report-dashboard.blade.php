...
<div class="container-fluid px-0">
    ...
    <div class="rounded pt-4">
        ...
        <form method="post" id="student-filter-form" action="#">
        ...
        <table class="table align-middle table-hover">
            <thead class="thead-light text-center">
                <tr class="table-head-1">
                    ...
                    <th scope="col" class="table-th-text">학생 이름</th>
                    <th scope="col" class="table-th-text">학교</th>
                    <th scope="col" class="table-th-text">학과</th>
                    <th scope="col" class="table-th-text">리포트 제목</th>
                    <th scope="col" class="table-th-text">제출 파일</th>
                    <th scope="col" class="table-th-text">채점 사항</th>
                    <th scope="col" class="table-th-text">제출일</th>
                </tr>
            </thead>
            <tbody class="text-center">
                <tr>
                    ...
                    <td>간호학과</td>
                    <td>
                        <a href="{{ route('stuReportDetails') }}" class="td-a-custom">
