...
<div class="container-fluid border-b1 px-0">
    <div class="page-title-top">
        <div class="rounded">
            <div class="d-flex align-items-center justify-content-between">
                <h5 class="text-center mb-0">교수자 리포트 자료 상세</h5>
            </div>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="mb-28">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item breadcrumb-text1">
                <a href="{{ url('admin/insReportDash') }}">교수자 리포트 자료</a>
            </li>
            <li class="breadcrumb-item breadcrumb-text2 active" aria-current="page">교수자 리포트 자료 상세</li>
        </ol>
    </nav>
</div>
    ...
    <div class="table-responsive pt-4 mb-3">
        <table class="table align-middle table-hover">
            <tbody class="text-center">
                ...
                <tr>
                    <td scope="row" class="table-td-text1 bg-td height-52">교수명</td>
                    <td colspan="8" class="table-td-text2">
                        <div class="height-52 item-flex-align-start ps-4 pe-5">
                            <label class="lbl-y2 py-0 my-0 pe-5">
                                김행신
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <h5 class="alert-title text-center mt-1 mb-4">리포트 자료 삭제</h5>
