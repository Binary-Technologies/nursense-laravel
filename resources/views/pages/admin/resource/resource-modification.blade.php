                ...
                <tr class="table-head-2">
                    ...
                    <td colspan="8" class="table-td-text2">
                        <div class="form-check height-52 item-flex-align-start">
                            <input class="form-check-input ms-1 me-2" type="radio" name="exposureStatus"  value="1" {{ old('flexRadioDefault', $resource->status) == 1 ? 'checked' : '' }} onchange="exposureChange()"  id="flexRadioDefault1" >
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                ...
                <div class="item-flex-center my-2">
                    <div class="mx-1">
                        <a href="/admin/resourceUpdate/{{$resource->id}}" class="btn btn-alert3">
                            확인
                        </a>
                    </div>
                </div>
