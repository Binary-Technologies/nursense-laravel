...
<div class="container-fluid border-b1 px-0">
    ...
    <nav aria-label="breadcrumb" class="mb-28">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item breadcrumb-text2 active" aria-current="page">교수자 계정 관리</li>
        </ol>
    </nav>
</div>
        ...
        <form id="instructor-filter-form" method="POST" action="/admin/instructorDash/filterData">
            ...
            <div class="row mb-4">
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-xs-12">
                    <select class="form-select form-text-d" value="{{ request('university') }}" name="university" id="university" aria-label="University Selection" onchange="showDepartments()">
            ...
            <div class="row mb-4">
                ...
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6">
                    <a href="{{ route('insReg') }}" class="btn btn-secondary btn3">
                        교수자 등록
                    </a>
                </div>
