                ...
                <form method="post" id="insProfEdit" class="" action="#">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-4 pe-2">
                            ...
                            <input type="text" class="form-control form-text-d fields-height1" name="stu-id" id="stuId" placeholder="01012345678" aria-describedby="Student ID">
                        </div>
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="item-flex-center my-4">
                        <div class="width-70 my-2">
                            <a class="btn btn10" data-bs-target="#dpUploadSaveModal" data-bs-toggle="modal">등록 저장</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="item-flex-center my-4">
                        <div class="width-70 my-2">
                            <button class="btn btn10" data-bs-target="#completionModal" data-bs-toggle="modal">등록 저장</button>
                        </div>
                    </div>
                </div>
            </div>
