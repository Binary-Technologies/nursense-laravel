                            ...
                            <form method="post" id="insProfEdit" class="" action="/Register-student">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-3 pe-2">
                                        ...
                                        <input type="text" class="form-control form-text-d fields-height1" value="{{ old ('name') }}" name="name" id="name" placeholder="이름을 입력하세요." aria-describedby="Student Name">
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-3 pe-2">
                                        ...
                                        <input type="text" class="form-control form-text-d fields-height1" value="{{ old ('job') }}" name="job" id="job" placeholder="직종을 입력해주세요. (예. 간호사, 물리치료사 등)" aria-describedby="Student Job">
                                    </div>
