                ...
                <form method="post" id="insProfEdit" class="" action="{{ route('studentUpdate', ['user' => $user->id]) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-4 pe-2">
                            ...
                            <input type="text" value="{{$user->name}}" class="form-control form-text-d fields-height1" name="name" id="name" placeholder="홍길동" aria-describedby="Student Name">
                        </div>

                        <!-- Mobile -->
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-4 pe-2">
                            <label class="form-text-lbl pb-2" for="mobile">* 휴대폰 번호</label>
                            <input type="phone" value="{{$user->pno}}" class="form-control form-text-d fields-height1" name="mobile" id="mobile" placeholder="01012345678" aria-describedby="Student Mobile">
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-4 pe-2">
                            ...
                            <input type="text" value="{{$user->std_id}}" class="form-control form-text-d fields-height1" name="stu-id" id="stuId" placeholder="12345678" aria-describedby="Student ID">
                        </div>

                        <!-- Email -->
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-4 pe-2">
                            <label class="form-text-lbl pb-2" for="email">* 이메일</label>
                            <input type="text" value="{{$user->email}}" class="form-control form-text-d fields-height1" name="email" id="email" placeholder="ghdrlfehd@gmail.com" aria-describedby="Student Email">
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-4 pe-2">
                            ...
                            <div class="item-flex-align-center width-70">
                                <input type="text" value="{{$user->resident_reg}}" class="form-control form-text-d fields-height1 me-2" name="res-reg-num1" id="resRegNum1" placeholder="670206" aria-describedby="Student Resident Registration Number1">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 pl-0 py-4 pe-2">
                            ...
                            <input type="text"  value="{{$user->occupation}}"class="form-control form-text-d fields-height1" name="job" id="job" placeholder="간호사" aria-describedby="Student Job">
                        </div>
