...
<nav aria-label="breadcrumb" class="mx-4 my-4">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><strong>Update User</strong></li>
    </ol>
</nav>
            ...
            <div class="col-lg-12">
                <div class="form-group row my-5 mx-2">
                    <div class="col-lg-12 item-flex-end">
                        <button type="submit" name="update_user" class="btn btn-primary btn-custom mb-3">Submit</button>
                    </div>
                </div>
            </div>
