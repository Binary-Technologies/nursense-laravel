...
<div class="container-fluid px-0">
            ...
            <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td colspan="8" class="table-td-text2">
                        <div class="item-flex-center width-15 ml30">
                            <img src="{{ asset('assets/img/gallery.png') }}" class="width-100">
                        </div>
                    </td>
                </tr>
                <tr class="table-head-3">
                    ...
                    <td colspan="8" class="table-td-text2">
                        ...
                        <div class="item-flex-start ml25 mt-4 me-5">
                            <img src="{{ asset('assets/img/desc-img.png') }}" class="width-100">
                        </div>
                    </td>
                </tr>
    ...
    <div class="row mt-4 mb-5">
        <div class="item-flex-end">
            ...
            <a href="{{ route('galleryUpdate') }}" class="btn btn13 ms-3">
                수정
            </a>
        </div>
    </div>
