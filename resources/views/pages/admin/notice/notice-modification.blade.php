        ...
        <table class="table align-middle table-hover">
            <tbody class="text-center">
                <tr class="table-head-2">
                    ...
                    <td colspan="8" class="table-td-text2">
                        <div class="form-check height-52 item-flex-align-start">
                            <input class="form-check-input ms-1 me-2" type="radio" name="flexRadioDefault" value="0" {{ old('flexRadioDefault', $notice->main_exposure) == 0 ? 'checked' : '' }} onchange="mainExposureChange()" id="flexRadioDefault1" >
                ...
                <tr class="table-head-2">
                    ...
                    <td colspan="8" class="table-td-text2">
                        <div class="form-check height-52 item-flex-align-start">
                            <input class="form-check-input ms-1 me-2" type="radio" name="flexRadioDefault2" value="0" {{ old('flexRadioDefault2', $notice->exposure) == 0 ? 'checked' : '' }}  onchange="exposureChange()" id="flexRadioDefault3" >
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                ...
                <div class="item-flex-center my-2">
                    <div class="mx-1">
                        <a href="/admin/noticeUpdate/{{$notice->id}}" class="btn btn-alert3">
                            확인
                        </a>
                    </div>
                </div>
