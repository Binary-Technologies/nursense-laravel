        ...
        <form id="notice-filter-form" method="POST" action="/admin/noticeDash/filterData">
            ...
            <div class="row mb-4">
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <input type="search" value="{{ request('search') }}"  class="form-control form-text-l search-bar-custom" name="search" id="searchNotice" placeholder="제목을 입력하세요." aria-label="Search">
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-xs-12">
