...
<div class="container-fluid border-b1 px-0">
    <div class="page-title-top">
        <div class="rounded">
            <div class="d-flex align-items-center justify-content-between">
                <h5 class="text-center mb-0">소식 등록</h5>
            </div>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="mb-28">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item breadcrumb-text2 active" aria-current="page">소식 등록</li>
        </ol>
    </nav>
</div>
                ...
                <tr>
                    ...
                    <td colspan="8" class="table-td-text2">
                        <div class="height-52 item-flex-start width-50 ml30 my-3">
                            <input type="text" class="form-control val-text" name="news-title" id="newsName" placeholder="제목을 입력하세요." value="" aria-describedby="News Title Input">
                        </div>
                    </td>
                </tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                ...
                <div class="item-flex-center my-2">
                    <div class="mx-1">
                        <button class="btn btn-alert3" data-bs-target="#newsAddExitModal" data-bs-toggle="modal">확인</button>
                    </div>
                </div>
            </div>
        </div>
...
<!-- News Add Exit Alert Modal -->
<div class="modal fade" id="newsAddExitModal" aria-hidden="true" aria-labelledby="newsAddExitModalContent" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center my-3" id="newsAddExitModalContent"></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body pt-0">
