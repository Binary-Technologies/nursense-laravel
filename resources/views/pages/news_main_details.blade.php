                ...
                <div class="auto-container">
                    <div class="content-box">
                        <div class="title" style="margin-top: -40px; margin-left: -40px;">
                            <h2 class="text-left text-white" style="font-family: pretendard-bold; font-size: 24px;">소식</h2>
                            <p class="text-left cl-w text-white" style="font-family: pretendard-regular; font-size: 14px;">새로운 소식을 한곳에서 확인하세요.</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td colspan="2" style="text-align: right; padding: 20px; ">
                                    <a href="/info/news" class="btn btn-outline-secondary btn-sm btn-search my-2 my-sm-0" type="submit" style="background-color: #ffffff;color: #212880;padding-bottom: 10px;padding-top: 10px;padding-left: 50px;padding-right: 50px;border-color: #1B3EA8; border-radius: 6px;font-size: 16px;">
                                        목록
                                    </a>
