                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td colspan="2" style="text-align: right; padding: 20px; ">
                                    <a href="/info/news" class="btn btn-outline-secondary btn-sm btn-search my-2 my-sm-0" type="submit" style="background-color: #ffffff;color: #212880;padding-bottom: 10px;padding-top: 10px;padding-left: 50px;padding-right: 50px;border-color: #1B3EA8; border-radius: 6px;">
                                        목록
                                    </a>
