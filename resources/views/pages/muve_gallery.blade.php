                ...
                <div class="col-md-6">
                    <form class="form-inline justify-content-end mx-3 my-2 my-lg-0">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control search-bar-custom inner-search-bar" placeholder=" 검색어를 입력하세요." aria-label="Search">
                        </div>

                        <button class="btn btn-outline-secondary btn-sm btn-search2 my-2 my-sm-0" type="submit">검색</button>
                    </form>
                </div>
            ...
            <div class="row">
                ...
                <div class="gallery_img_margin">
                    ...
                    <div class="text-justify">
                        <p class="gallery-img-desc pt5" style="font-family: pretendard-regular; font-size: 14px; color: #9495A1;">
                            <립모션 장치>
                                <위 장치로 시뮬레이션 하는 모습> {!! html_entity_decode($gallery->details) !!}
                        </p>
                    </div>
