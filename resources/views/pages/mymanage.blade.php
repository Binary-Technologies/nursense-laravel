                ...
                <div class="col-lg-12">
                    <div class="row my-5">
                        <div class="col-2" style="color: #FFFFFF;">
                            <select class="form-control mr-sm-2 height-52 search-bar-custom">
            ...
            <div class="row" style="font-size: 14px;">
                ...
                <div class="col-8 item-flex-right">
                    <nav aria-label="Page navigation muve gallery">
                        ...
                        <!-- Binded data - Not From Front End Design -->
                        <!-- Used d-none for hide this part because it doesn't work with design -->
