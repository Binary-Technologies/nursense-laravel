                        ...
                        <div class="col-lg-12 bg-color-2 border-rad-10">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <p class="ttl-12 ">01012345678</p>
                                </div>
                                <div class="col-lg-6">
                                    <label class="ttl-3 pt-3 mb-1">이메일</label>
                                    <p class="ttl-12 ">abc@naver.com</p>
                                </div>
                                <div class="col-lg-12">
                                    <div class="border-b-cus2"></div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="item-flex-center">
                                                ...
                                                <div class="width-30">
                                                    <div class="item-flex-right">
                                                        <span class="progress-percent ml-2">60%</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="item-flex-center">
                                                <div class="width-70">
                                                    <div class="item-flex-left">
                                                        <div class="progress">
                                                            <div class="progress-bar" role="progressbar" style="width: 88%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="width-30">
                                                    <div class="item-flex-right">
                                                        <span class="progress-percent ml-2">88%</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
