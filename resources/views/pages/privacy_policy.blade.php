...
<section class="py-5 px-5 pt-5">
    <div class="px-5 pt-5">
        <div class="row">
            ...
            <div class="docu-details py-3 pt-5 pl-0">
                <h1 class="terms_heading pt-4">개인정보처리방침</h1>
            </div>
            <div class="col-md-12 border-rad-10 pt-5 px-5 border-solid">


                <div class="mb-5 text-justify">
                    <ul class="pr-1 terms_contents">
                        <li>회사명(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.</li>
                    </ul>
                </div>
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제1조 (개인정보의 처리목적)</h3>
                    <ul class="pr-1 terms_contents">
                        ...
                        <li>회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충 처리 등을 목적으로 개인정보를 처리합니다.</li>
                        <li>&nbsp;</li>
                        <li>2. 재화 또는 서비스 제공</li>
                        <li>물품 배송, 서비스 제공, 계약서 및 청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금 결제 및 정산, 채권추심 등을 목적으로 개인정보를 처리합니다.</li>
                        <li>&nbsp;</li>
                        <li>3. 고충 처리</li>
                        <li>민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락․통지, 처리 결과 통보 등의 목적으로 개인정보를 처리합니다.</li>
                    </ul>
                </div>
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제2조 (개인정보의 처리 및 보유기간)</h3>
                    <ul class="pr-1 terms_contents">
                ...
                <div class="mb-5 text-justify">
                    <ul class="pr-1 terms_contents">
                        <li>2. 재화 또는 서비스 제공 : 재화․서비스 공급완료 및 요금결제․정산 완료 시까지</li>
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제3조 (개인정보의 제3자 제공)</h3>
                    <ul class="pr-1 terms_contents">
                        <li>① 회사는 정보주체의 개인정보를 제1조(개인정보의 처리목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</li>
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제4조(개인정보처리의 위탁)</h3>
                    <ul class="pr-1 terms_contents">
                        <li>① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</li>
                        <li>&nbsp;</li>
                        <li>1. 전화 상담 센터 운영</li>
                        <li>- 위탁받는 자 (수탁자) : OOO CS센터</li>
                        <li>- 위탁하는 업무의 내용 : 전화상담 응대, 부서 및 직원 안내 등</li>
                        <li>&nbsp;</li>
                        <li>2. A/S 센터 운영</li>
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제5조(이용자 및 법정대리인의 권리와 그 행사 방법)</h3>
                    <ul class="pr-1 terms_contents">
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제6조(처리하는 개인정보 항목)</h3>
                    <ul class="pr-1 terms_contents">
                        <li>회사는 다음의 개인정보 항목을 처리하고 있습니다.</li>
                        <li>&nbsp;</li>
                        <li>1. 홈페이지 회원 가입 및 관리</li>
                        <li>필수항목 : <예) 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 성별, 이메일주소, 아이핀번호>
                        </li>
                        <li>선택항목 : <예) 결혼 여부, 관심 분야>
                        </li>
                        <li>&nbsp;</li>
                        <li>2. 재화 또는 서비스 제공</li>
                        <li>필수항목 : <예) 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 이메일주소, 아이핀번호, 신용카드번호, 은행계좌정보 등 결제정보>
                        </li>
                        <li>선택항목 : <관심분야, 과거 구매내역>
                        </li>
                        <li>&nbsp;</li>
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제7조(개인정보의 파기)</h3>
                    <ul class="pr-1 terms_contents">
                        ...
                        <li>2. 파기 방법</li>
                        <li>회사는 전자적 파일 형태로 기록․저장된 개인정보는 기록을 재생할 수 없도록 로우레밸포멧(Low Level Format) 등의 방법을 이용하여 파기하며, 종이 문서에 기록․저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.</li>
                    </ul>
                </div>
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제8조(개인정보의 안전성 확보조치)</h3>
                    <ul class="pr-1 terms_contents">
                        <li>회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 하고 있습니다.</li>
                        <li>1. 관리적 조치 : 내부관리계획 수립 및 시행, 정기적 직원 교육 등</li>
                        <li>2. 기술적 조치 : 개인정보처리시스템 등의 접근 권한 관리, 접근통제시스템 설치, 고유 식별정보</li>
                        <li>등의 암호화, 보안프로그램 설치</li>
                        <li>3. 물리적 조치 : 전산실, 자료보관실 등의 접근통제</li>
                    </ul>
                </div>
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제9조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h3>
                    <ul class="pr-1 terms_contents">
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제10조(개인정보 보호책임자)</h3>
                    <ul class="pr-1 terms_contents">
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제11조(개인정보 열람청구)</h3>
                    <ul class="pr-1 terms_contents">
                ...
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제12조(권익침해 구제 방법)</h3>
                    <ul class="pr-1 terms_contents">
                        ...
                        <li>▶ 경찰청 사이버안전국 : 182 (<a href='http://cyberbureau.police.go.kr' target='_blank'>http://cyberbureau.police.go.kr</a>)</li>
                    </ul>
                </div>
                <div class="mb-5 text-justify">
                    <h3 class="pb-3 terms_titles">제13조(개인정보 처리방침 시행 및 변경)</h3>
                    <ul class="pr-1 terms_contents">
                        <li>이 개인정보 처리방침은 20XX. X. X부터 적용됩니다.</li>
                    </ul>
                </div>
