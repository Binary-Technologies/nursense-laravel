          ...
          <div class="docu-details item-flex-center">
            ...
            <div class="mt-3">
              <div class="form-group">
                <label for="email" class="login_desc"><small>휴대폰 번호</small></label>
                <div class="item-flex-left">
                  <input type="email" name='email' id='email' class="form-control login_text ttl-23 height-52 width-70 mr-3" placeholder="휴대폰 번호를 입력해주세요." aria-describedby="Email" required>
                  <!-- If Deactive -->
