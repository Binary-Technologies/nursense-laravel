...
<!-- banner-section -->
<section class="banner-section" style="background-color: #F4F5FA; height:720px; width: 1920px;">
    <div class="row" style="margin-left: 90px; margin-top: 90px;">
        <div class="col-lg-3">
            <h5 style="margin-top: 100px; font-family: pretendard-bold; font-size: 32px; color: #3941A2;">책방 그루잠 소록소록 예그리나</h5>
            <div>&nbsp;</div>
            <p style="font-family: pretendard-medium; font-size: 16px; color: #616474;">책방 그루잠 소록소록 예그리나 다솜 책방 그루잠 소록소록 예그리나 다솜 책방 그루잠 소록소록 예그리나 다솜 책방 책방 그루잠 소록소록 책방 그루잠 소록소록 예그리나 다솜 책방 그루잠 소록소록 예그리나</p>
        ...
        <div class="col-lg-9">
            <img src="images/sliders/slide1.png" style="width: 1254px; height: 546px; border-radius: 16px;"/>
            <img src="images/msg.png" class="arrow_btn" style="width: 64px; float: right; margin-right: 20px; margin-top: 480px;"/>
        </div>
    </div>
</section>
<!-- banner-section end -->
...
<section style="width: 1920px;">
    <div class="container pt-5" style="width: 100%;padding: 0px; margin: 0px;">
        <h2 style="font-family: pretendard-bold; font-size: 28px; color: #090909; margin-left: 120px;">NURSENSE 안내사항</h2>
