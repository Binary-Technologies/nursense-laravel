...
class PageController extends Controller
{
    public function index(){
        ...
        $news = News::where('exposure', 1)->orderBy('id', 'desc')->get();
        $notices = Notice::where('exposure', 1)->orderBy('id', 'desc')->get();
        $main_news = News::where('main_exposure', 1)->orderBy('id', 'desc')->get();
        $main_notice = Notice::where('main_exposure', 1)->orderBy('id', 'desc')->get();
